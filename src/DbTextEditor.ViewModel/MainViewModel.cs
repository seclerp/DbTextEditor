...
namespace DbTextEditor.ViewModel
{
    public class MainViewModel : IMainViewModel
    {
        ...
        public ObservableCollection<IEditorViewModel> OpenedEditors { get; } =
            new ObservableCollection<IEditorViewModel>();

        public ObservableProperty<IEditorViewModel> SelectedEditor { get; } =
